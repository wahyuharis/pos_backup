...
class Table_group extends CI_Controller {
	...
	public function Export()
    {
        ...
        $excel->getProperties()->setCreator('Ultrapos')
                 ...
                 ->setTitle("Data Group Meja")
                 ->setSubject("Group Meja")
                 ->setDescription("Laporan Group Meja")
                 ->setKeywords("Data Group Meja");
        ...
        $excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA GROUP MEJA");
        ...
        $excel->setActiveSheetIndex(0)->setCellValue('B3', "Group");
        ...
        $www=array('idbusiness'=>$this->session->userdata('id_business'),'status_group'=>1);
        $register=$this->data_model->getsomething('table_group',$www);
        ...
        foreach($register as $data):
            ...
            $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $data->nama_group);
        ...
        $excel->getActiveSheet(0)->setTitle("Laporan Data Group Meja");
        $excel->setActiveSheetIndex(0);

        header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
        header('Content-Disposition: attachment; filename="Laporan Data Group Meja.xlsx"');
