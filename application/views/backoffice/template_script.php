...
<script>
    ...
    $(window).on('load', function () {
        ...
        $('#notif-tutorial').on('hidden.bs.modal', function () {
            ...
            if (take_tutorial == '1') {
                $(".dark-container").show();
                $('.tooltip-step').html('Step 1/<?= $max_step ?>');
                $('#tooltip_1').append('<button class="btn btn-primary btn-xs saya-mengerti">Saya Mengerti</button>');
                $('#tooltip_1').show();
                $('#select_1').show();
                ...
                $('#side_item_library').click(function () {
                    take_tutorial = window.localStorage.getItem('take_tutorial');
                    if (first_click == 0 && take_tutorial == '1') {
                        $('.tooltip-step').html('Step 2/<?= $max_step ?>');
                        $(".dark-container").show();
