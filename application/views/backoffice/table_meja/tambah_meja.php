<div class="wrapper">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form method="POST" id="validationForm" action="<?php echo base_url(); ?>backoffice/table_meja/insert_meja" autocomplete="off">
				<div class="form">
					<div class="row">
						<div class="col-md-4">
								...
								<div class="input-group">
									...
									<select name="idgroup" class="form-control">
										...
										<?php foreach ($group as $g) { ?>
											<option value="<?= $g->idgroup ?>"><?= $g->nama_group ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
								...
								<div class="input-group">
									...
									<select name="idoutlet" class="form-control">
										...
										<?php foreach ($outlet as $o) { ?>
											<option value="<?= $o->idoutlet ?>"><?= $o->name_outlet ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
