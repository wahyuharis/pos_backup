        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <p>Halaman diskon digunakan untuk mengelola diskon, anda dapat menambahkan diskon baru atau mengedit dan menghapus diskon yang ada.</p>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form method="POST" action="<?php echo base_url(); ?>backoffice/diskon/delete">
                ...
                <div class="modal-body text-center">
                    ...
                    <input type="hidden" name="id_diskon" value="">
                </div>
...
<script>
    function delete_validation(id_diskon) {
        $('input[name=id_diskon]').val(id_diskon);
    ...
    $(document).ready(function () {
        var table = $('#promo-list').DataTable({
            'ajax': {
                'url': '<?= base_url() ?>backoffice/diskon/datatable/',
