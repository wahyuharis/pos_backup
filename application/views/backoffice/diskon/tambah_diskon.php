...
<div class="wrapper">
    ...
    <div class="form">
        <form id="validationForm" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>backoffice/diskon/submit" autocomplete="off">
            <?= form_hidden('iddiskon', $iddiskon) ?>
            <div class="row">
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-body same_height">
                            <center>
                                <h4>Produk Sedang Promo</h4>
                            </center><br>
                            ...
                            <div id="qty_buy" style="" class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="1" id="diskon" name="diskon" value="<?= $diskon ?>" class="form-control number-header">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body same_height">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="tgl_mulai" type="text" value="<?= $tgl_mulai ?>" class="form-control singgle-tanggal">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" style="background-color: white"><i class="fa fa-calendar" aria-hidden="true"></i></i></span>
                                    <input name="tgl_akhir" type="text" value="<?= $tgl_akhir ?>" class="form-control singgle-tanggal">
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="form-group">
                                <a href="<?php echo base_url(); ?>backoffice/diskon" type="button" class="btn btn-default"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Kembali</a>
...
<script>
    ...
    $('#validationForm').submit(function(e) {
        ...
        $.ajax({
            url: "<?= base_url() ?>backoffice/diskon/submit/", // Url to which the request is send
            ...
            success: function(data) // A function to be called if request succeeds
            {
                if (!data.status) {
                    ...
                    window.location = '<?= base_url() ?>backoffice/diskon/';
                }
