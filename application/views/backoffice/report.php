            ...
            <div class="panel panel-default">
				...
				<div class="input-group" style="width: 150px">
                    ...
                    <div class="pull-right form-inline">
                        <a target="_blank" href="<?= base_url() ?>/backoffice/report/export_excel2" class="btn btn-success" id="export_excel" type="button" >Export</a>
                    </div>
                ...
                <div class="panel panel-body">
                    ...
                    <div class="table-responsive">
                        <table id="table-report" class="table table-bordered table-condensed table-strip" style="width: 100%">
                            <thead class="bg">
                                <tr>
                                    <th>No</th>
                                    <th>Produk</th>
