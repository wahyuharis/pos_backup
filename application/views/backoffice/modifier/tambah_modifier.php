...
<div class="wrapper">
	<div class="panel panel-default">
		<div class="panel-body">
			<h4>Tambah Modifier</h4>
		</div>
	</div>

	<div class="form">
		<form id="form-produk" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>backoffice/modifier/insert_modifier" autocomplete="off">
			<div class="row">
				<div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-body same_height">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" name="nama_modifier" class="form-control" placeholder="Nama Modifier" required>
								</div>
							</div><br>
							Pilihan Sub Modifier
						...
						<div class="panel-body same_height">
							...
							<div class="form-group scroll-content">
								...
								<table id="tableproduk" class="table table-condensed table-strip">
									<thead>
										<tr>
											<th width="20%"><input type="checkbox" name="cb-all"> Check <i class="fa fa-check-circle-o" aria-hidden="true"></i></th>
									...
									<tbody>
										<?php foreach ($compro as $rw) : ?>
											<tr>
												<td width="20%"><input type="checkbox" name="produk" class="list-checkbox" id="produk" value="<?php echo $rw->idproduk; ?>"></td>
