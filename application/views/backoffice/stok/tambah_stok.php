                    ...
                    <div class="col-md-4" style="">
                        <div id="produk_buy" style="" class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="produk_add" class="form-control" placeholder="Pilih Produk - Variant">
                                    <?= $selected_item ?>
                                </select>
                            </div>
                        </div>
                        <div style="" class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?= form_dropdown('outlet', $outlet, array(), ' class="form-control" id="outlet"  ') ?>
                            </div>
                        </div>
                        <div style="" class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" min="1" name="qty_add" value="<?= $qty_add ?>" class="form-control number-header">
                            </div>
                        </div>
...
<script type="text/javascript">
    $('select[name=produk_add]').select2({
        ajax: {
    ...
    $('#validationForm').submit(function(e) {
        ...
        $.ajax({
            url: "<?= base_url() ?>backoffice/stok/submit_add_stok/", // Url to which the request is send
