<div class="login-form">
	<form method="POST" id="validationForm" class="form form-login" action="<?php echo base_url(); ?>home/step4" autocomplete="off">
		<h2>Step 4/7 : Data Owner</h2>
		<div class="form-group">
			<label for="">Nama</label>
			<div class="input-group">
				<div class="input-group-addon" style="background-color: white"><i class="fa fa-user-circle-o" aria-hidden="true"></i></div>
				<input type="text" name="nama_own" value="<?php echo $this->session->userdata('nama_own'); ?>" class="form-control" placeholder="Nama Owner" required>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" id="no-telp" maxlength="13" name="telp" value="<?php echo $this->session->userdata('telp_own'); ?>" class="form-control" required>
					</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" id="email" name="email_own" value="<?php echo $this->session->userdata('email_own'); ?>" class="form-control" required>
					</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="password" id="password" name="password_own" class="form-control" required>
					</div>
				</div>
			</div>
			<div class="col-md-6">
		...
		<?php if ($this->session->userdata('kode_own') == NULL) {; ?>
			<input type="text" style="display: none;" name="kode_own" value="<?php echo $kode; ?>" class="form-control" required>
		<?php } else {; ?>
			<input type="text" style="display: none;" name="kode_own" value="<?php echo $this->session->userdata('kode_own'); ?>" class="form-control" required>
		<?php }; ?>
		<br />
		<div class="form-group">
			<a href="<?php echo base_url(); ?>home/register3" class="btn btn-default">
				<i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back</a> <button class="btn btn-primary" id="bsub" type="submit">Next Input Outlet <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
		</div>
	</form>
</div>
	...
	$(function() {
		$('#validationForm').validate({
			...
			messages: {
				...
				telp: {
					required: "Silahkan isi nomor telepone Anda",
